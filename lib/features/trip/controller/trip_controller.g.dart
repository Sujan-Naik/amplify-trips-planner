...
abstract class _$TripController
  ...
  FutureOr<Trip> build(String tripId);
}
...
class TripControllerFamily extends Family<AsyncValue<Trip>> {
  ...
  /// See also [TripController].
  TripControllerProvider call(String tripId) {
    return TripControllerProvider(tripId);
  }
...
class TripControllerProvider
  ...
  /// See also [TripController].
  TripControllerProvider(String tripId)
    : this._internal(
  ...
  @override
  FutureOr<Trip> runNotifierBuild(covariant TripController notifier) {
